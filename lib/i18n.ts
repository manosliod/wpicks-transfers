...
import { fetchCrowdinTranslation } from '@/utils/fetchCrowdinTranslation';
...
i18next
    ...
    .init({
        ...
        defaultNS: 'common',
        backend: {
            request: async (options: any, url: string, payload: any, callback: (arg0: unknown, arg1: { data?: string; status: number; }) => void) => {
